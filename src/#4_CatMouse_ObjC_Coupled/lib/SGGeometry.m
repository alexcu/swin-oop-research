...
+ (SGCircle *)createCircleX:(float)x  y:(float)y  radius:(int)radius
{
    SGCircle * result;
    result = [SGCircle circleForData:sg_Geometry_CreateCircleFromXY(x, y, radius)];
    return result;
}

+ (SGCircle *)createCircle:(SGPoint2D *)pt  radius:(int)radius
{
    SGCircle * result;
    result = [SGCircle circleForData:sg_Geometry_CreateCircle(&pt->data, radius)];
    return result;
}

+ (SGLineSegment *)createLineX1:(float)x1  y1:(float)y1  toX2:(float)x2  y2:(float)y2
{
    SGLineSegment * result;
    result = [SGLineSegment lineSegmentForData:sg_Geometry_CreateLine(x1, y1, x2, y2)];
    return result;
}

+ (SGLineSegment *)createLine:(SGPoint2D *)pt1  to:(SGPoint2D *)pt2
{
    SGLineSegment * result;
    result = [SGLineSegment lineSegmentForData:sg_Geometry_CreateLinePointToPoint(&pt1->data, &pt2->data)];
    return result;
}

+ (SGVector *)createLineAsVector:(SGLineSegment *)line
{
    SGVector * result;
    result = [SGVector vectorForData:sg_Geometry_CreateLineAsVector(&line->data)];
    return result;
}

+ (SGLineSegment *)createLineFromVector:(SGVector *)mv
{
    SGLineSegment * result;
    result = [SGLineSegment lineSegmentForData:sg_Geometry_CreateLineFromVector(&mv->data)];
    return result;
}

+ (SGLineSegment *)createLineFrom:(SGPoint2D *)pt  toOffset:(SGVector *)mv
{
    SGLineSegment * result;
    result = [SGLineSegment lineSegmentForData:sg_Geometry_CreateLineVectorWithStartPoint(&pt->data, &mv->data)];
    return result;
}

+ (SGLineSegment *)createLineFromX:(float)x  y:(float)y  toOffset:(SGVector *)mv
{
    SGLineSegment * result;
    result = [SGLineSegment lineSegmentForData:sg_Geometry_CreateLineVectorWithStartXY(x, y, &mv->data)];
    return result;
}

+ (SGRectangle *)createRectangleX:(float)x  y:(float)y  width:(int)w  height:(int)h
{
    SGRectangle * result;
    result = [SGRectangle rectangleForData:sg_Geometry_CreateRectangle(x, y, w, h)];
    return result;
}

+ (SGRectangle *)createRectangleLines:(NSArray *)lines
{
    line_segment lines_temp[[lines count]];
    SGRectangle * result;
    [SGLineSegment getLineSegments:lines_temp fromArray:lines maxSize:[lines count]];
    result = [SGRectangle rectangleForData:sg_Geometry_CreateRectangleLines(lines_temp, [lines count])];
    return result;
}

+ (SGRectangle *)createRectangleTriangle:(SGTriangle *)tri
{
    SGRectangle * result;
    result = [SGRectangle rectangleForData:sg_Geometry_CreateRectangleTriangle(&tri->data)];
    return result;
}

+ (SGRectangle *)createRectangleLine:(SGLineSegment *)line
{
    SGRectangle * result;
    result = [SGRectangle rectangleForData:sg_Geometry_CreateRectangleLine(&line->data)];
    return result;
}

+ (SGRectangle *)createRectangleCircle:(SGCircle *)c
{
    SGRectangle * result;
    result = [SGRectangle rectangleForData:sg_Geometry_CreateRectangleCircle(&c->data)];
    return result;
}

+ (SGRectangle *)createRectangle:(SGPoint2D *)pt1  to:(SGPoint2D *)pt2
{
    SGRectangle * result;
    result = [SGRectangle rectangleForData:sg_Geometry_CreateRectangleForPoints(&pt1->data, &pt2->data)];
    return result;
}

+ (SGRectangle *)createRectangle:(SGPoint2D *)pt  width:(int)width  height:(int)height
{
    SGRectangle * result;
    result = [SGRectangle rectangleForData:sg_Geometry_CreateRectangleAtPoint(&pt->data, width, height)];
    return result;
}

+ (SGTriangle *)createTriangleAx:(float)ax  ay:(float)ay  bx:(float)bx  by:(float)by  cx:(float)cx  cy:(float)cy
{
    SGTriangle * result;
    result = [SGTriangle triangleForData:sg_Geometry_CreateTriangle(ax, ay, bx, by, cx, cy)];
    return result;
}

+ (SGTriangle *)createTrianglePtA:(SGPoint2D *)a  ptB:(SGPoint2D *)b  ptC:(SGPoint2D *)c
{
    SGTriangle * result;
    result = [SGTriangle triangleForData:sg_Geometry_CreateTrianglePoints(&a->data, &b->data, &c->data)];
    return result;
}

+ (SGVector *)createvectorFromAngle:(float)angle  magnitude:(float)magnitude
{
    SGVector * result;
    result = [SGVector vectorForData:sg_Geometry_CreateVectorFromAngle(angle, magnitude)];
    return result;
}

+ (SGVector *)createvectorFromPt:(SGPoint2D *)pt  to:(SGRectangle *)rect
{
    SGVector * result;
    result = [SGVector vectorForData:sg_Geometry_CreateVectorFromPointPtToRectangle(&pt->data, &rect->data)];
    return result;
}

+ (SGVector *)createvectorFromX:(float)x  y:(float)y  toRect:(SGRectangle *)rect
{
    SGVector * result;
    result = [SGVector vectorForData:sg_Geometry_CreateVectorFromPointToRectangle(x, y, &rect->data)];
    return result;
}

+ (SGVector *)createvectorFromX:(float)x  y:(float)y  toRectX:(float)rectX  y:(float)rectY  width:(int)rectWidth  height:(int)rectHeight
{
    SGVector * result;
    result = [SGVector vectorForData:sg_Geometry_CreateVectorFromPointToRect(x, y, rectX, rectY, rectWidth, rectHeight)];
    return result;
}

+ (SGVector *)createVectorFrom:(SGPoint2D *)p1  to:(SGPoint2D *)p2
{
    SGVector * result;
    result = [SGVector vectorForData:sg_Geometry_CreateVectorFromPoints(&p1->data, &p2->data)];
    return result;
}

+ (SGVector *)createVectorToPoint:(SGPoint2D *)p1
{
    SGVector * result;
    result = [SGVector vectorForData:sg_Geometry_CreateVectorToPoint(&p1->data)];
    return result;
}
...
{
    SGMatrix2D * result;
    result = [SGMatrix2D matrix2DForData:sg_Geometry_MatrixMultiply(&m1->data, &m2->data)];
    return result;
}
...
+ (BOOL)pointX:(float)ptX  y:(float)ptY  inCircleX:(float)cX  y:(float)cY  radius:(float)radius
{
    BOOL result;
    result = sg_Geometry_PointXYInCircle(ptX, ptY, cX, cY, radius) != 0;
    return result;
}
...
+ (SGPoint2D *)randomScreenPoint
{
    SGPoint2D * result;
    result = [SGPoint2D point2DForData:sg_Geometry_RandomScreenPoint()];
    return result;
}
...
{
    SGTriangle * result;
    result = [SGTriangle triangleForData:sg_Geometry_TriangleFrom(ax, ay, bx, by, cx, cy)];
    return result;
}

+ (SGTriangle *)triangleFromPtA:(SGPoint2D *)a  ptB:(SGPoint2D *)b  ptC:(SGPoint2D *)c
{
    SGTriangle * result;
    result = [SGTriangle triangleForData:sg_Geometry_TriangleFromPoints(&a->data, &b->data, &c->data)];
    return result;
}
