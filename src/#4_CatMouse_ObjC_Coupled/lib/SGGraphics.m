...
{
    sg_Graphics_DrawOrFillCircle(clr, 0, xc, yc, radius);
}

+ (void)draw:(color)clr  circleAt:(SGPoint2D *)position  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircleAtPoint(clr, 0, &position->data, radius);
}

+ (void)draw:(color)clr  filled:(BOOL)filled  circleAt:(SGPoint2D *)position  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircleAtPoint(clr, (filled ? 1 : 0), &position->data, radius);
}

+ (void)draw:(color)clr  circle:(SGCircle *)c
{
    sg_Graphics_DrawOrFillCircleStruct(clr, 0, &c->data);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  circle:(SGCircle *)c
{
    sg_Graphics_DrawOrFillCircleStructOnto(dest->pointer, clr, 0, &c->data);
}

+ (void)draw:(color)clr  filled:(BOOL)filled  circle:(SGCircle *)c
{
    sg_Graphics_DrawOrFillCircleStruct(clr, (filled ? 1 : 0), &c->data);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  filled:(BOOL)filled  circle:(SGCircle *)c
{
    sg_Graphics_DrawOrFillCircleStructOnto(dest->pointer, clr, (filled ? 1 : 0), &c->data);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  circle:(SGPoint2D *)point  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircleAtPointOnto(dest->pointer, clr, 0, &point->data, radius);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  circleX:(float)xc  y:(float)yc  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircleOnto(dest->pointer, clr, 0, xc, yc, radius);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  filled:(BOOL)filled  circle:(SGPoint2D *)point  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircleAtPointOnto(dest->pointer, clr, (filled ? 1 : 0), &point->data, radius);
}

+ (void)draw:(color)clr  filled:(BOOL)filled  circleX:(float)xc  y:(float)yc  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircle(clr, (filled ? 1 : 0), xc, yc, radius);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  filled:(BOOL)filled  circleX:(float)xc  y:(float)yc  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircleOnto(dest->pointer, clr, (filled ? 1 : 0), xc, yc, radius);
}

+ (void)draw:(color)clr  circleOnScreen:(SGCircle *)c
{
    sg_Graphics_DrawOrFillCircleStructOnScreen(clr, 0, &c->data);
}

+ (void)draw:(color)clr  filled:(BOOL)filled  circleOnScreen:(SGCircle *)c
{
    sg_Graphics_DrawOrFillCircleStructOnScreen(clr, (filled ? 1 : 0), &c->data);
}

+ (void)draw:(color)clr  circleOnScreenAt:(SGPoint2D *)position  radius:(int)radius
{
...
{
    sg_Graphics_DrawOrFillCircleOnScreen(clr, 0, xc, yc, radius);
}

+ (void)draw:(color)clr  filled:(BOOL)filled  circleOnScreenAt:(SGPoint2D *)position  radius:(int)radius
{
...
{
    sg_Graphics_DrawOrFillCircleOnScreen(clr, (filled ? 1 : 0), xc, yc, radius);
}
...
+ (void)drawEllipse:(color)clr  x:(float)xPos  y:(float)yPos  width:(int)width  height:(int)height
{
...
+ (void)draw:(color)clr  filled:(BOOL)filled  ellipseX:(float)xPos  y:(float)yPos  width:(int)width  height:(int)height
{
...
{
    sg_Graphics_DrawOrFillRectangleStruct(clr, 0, &source->data);
}

+ (void)draw:(color)clr  filled:(BOOL)filled  rectangle:(SGRectangle *)source
{
    sg_Graphics_DrawOrFillRectangleStruct(clr, (filled ? 1 : 0), &source->data);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  rectangle:(SGRectangle *)source
{
    sg_Graphics_DrawOrFillRectangleStructOnto(dest->pointer, clr, 0, &source->data);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  filled:(BOOL)filled  rectangle:(SGRectangle *)source
{
    sg_Graphics_DrawOrFillRectangleStructOnto(dest->pointer, clr, (filled ? 1 : 0), &source->data);
}
...
{
    sg_Graphics_DrawOrFillRectangleStructOnScreen(clr, 0, &source->data);
}

+ (void)draw:(color)clr  filled:(BOOL)filled  rectangleOnScreen:(SGRectangle *)source
{
    sg_Graphics_DrawOrFillRectangleStructOnScreen(clr, (filled ? 1 : 0), &source->data);
}
...
{
    sg_Graphics_DrawOrFillTriangleStruct(clr, 0, &tri->data);
}

+ (void)draw:(color)clr  filled:(BOOL)filled  triangle:(SGTriangle *)tri
{
    sg_Graphics_DrawOrFillTriangleStruct(clr, (filled ? 1 : 0), &tri->data);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  triangle:(SGTriangle *)tri
{
    sg_Graphics_DrawOrFillTriangleStructOnto(dest->pointer, clr, 0, &tri->data);
}

+ (void)drawOnto:(SGBitmap *)dest  color:(color)clr  filled:(BOOL)filled  triangle:(SGTriangle *)tri
{
    sg_Graphics_DrawOrFillTriangleStructOnto(dest->pointer, clr, (filled ? 1 : 0), &tri->data);
}
...
{
    sg_Graphics_DrawTriangleOnto(dest->pointer, clr, x1, y1, x2, y2, x3, y3);
}

+ (void)draw:(color)clr  triangleOnScreen:(SGTriangle *)tri
{
    sg_Graphics_DrawOrFillTriangleStructOnScreen(clr, 0, &tri->data);
}

+ (void)draw:(color)clr  filled:(BOOL)filled  triangleOnScreen:(SGTriangle *)tri
{
    sg_Graphics_DrawOrFillTriangleStructOnScreen(clr, (filled ? 1 : 0), &tri->data);
}
...
{
    sg_Graphics_DrawOrFillCircle(clr, 1, xc, yc, radius);
}

+ (void)fill:(color)clr  circle:(SGPoint2D *)position  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircleAtPoint(clr, 1, &position->data, radius);
}

+ (void)fill:(color)clr  circle:(SGCircle *)c
{
    sg_Graphics_DrawOrFillCircleStruct(clr, 1, &c->data);
}

+ (void)fillOnto:(SGBitmap *)dest  color:(color)clr  circle:(SGCircle *)c
{
    sg_Graphics_DrawOrFillCircleStructOnto(dest->pointer, clr, 1, &c->data);
}

+ (void)fillOnto:(SGBitmap *)dest  color:(color)clr  circle:(SGPoint2D *)point  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircleAtPointOnto(dest->pointer, clr, 1, &point->data, radius);
}

+ (void)fillOnto:(SGBitmap *)dest  color:(color)clr  circleX:(float)xc  y:(float)yc  radius:(int)radius
{
    sg_Graphics_DrawOrFillCircleOnto(dest->pointer, clr, 1, xc, yc, radius);
}

+ (void)fill:(color)clr  circleOnScreen:(SGCircle *)c
{
    sg_Graphics_DrawOrFillCircleStructOnScreen(clr, 1, &c->data);
}

+ (void)fill:(color)clr  circleOnScreenAt:(SGPoint2D *)position  radius:(int)radius
{
...
{
    sg_Graphics_DrawOrFillCircleOnScreen(clr, 1, xc, yc, radius);
}
...
+ (void)fill:(color)clr  ellipseX:(float)xPos  y:(float)yPos  width:(int)width  height:(int)height
{
...
{
    sg_Graphics_DrawOrFillRectangleStruct(clr, 1, &source->data);
}

+ (void)fillOnto:(SGBitmap *)dest  color:(color)clr  rectangle:(SGRectangle *)source
{
    sg_Graphics_DrawOrFillRectangleStructOnto(dest->pointer, clr, 1, &source->data);
}
...
{
    sg_Graphics_DrawOrFillRectangleStructOnScreen(clr, 1, &source->data);
}
...
{
    sg_Graphics_DrawOrFillTriangleStruct(clr, 1, &tri->data);
}

+ (void)fillOnto:(SGBitmap *)dest  color:(color)clr  triangle:(SGTriangle *)tri
{
    sg_Graphics_DrawOrFillTriangleStructOnto(dest->pointer, clr, 1, &tri->data);
}
...
{
    sg_Graphics_FillTriangleOnto(dest->pointer, clr, x1, y1, x2, y2, x3, y3);
}

+ (void)fill:(color)clr  triangleOnScreen:(SGTriangle *)tri
{
    sg_Graphics_DrawOrFillTriangleStructOnScreen(clr, 1, &tri->data);
}
