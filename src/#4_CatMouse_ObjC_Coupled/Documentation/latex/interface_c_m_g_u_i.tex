...
\index{C\-M\-G\-U\-I@{C\-M\-G\-U\-I}!draw\-Animal\-:@{draw\-Animal\-:}}
\index{draw\-Animal\-:@{draw\-Animal\-:}!CMGUI@{C\-M\-G\-U\-I}}
\paragraph[{draw\-Animal\-:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (void) draw\-Animal\-: 
\begin{DoxyParamCaption}
\item[{({\bf C\-M\-Animal} $\ast$)}]{animal\-To\-Draw}
\end{DoxyParamCaption}
}\label{interface_c_m_g_u_i_a19f3e70e0f37470b08507130dc57fd53}
...
\item 
/\-Users/\-Alex/\-Dropbox/\-Swinburne/\-H\-I\-T2302 -\/ O\-O\-P/\-Projects/\-Cat and Mouse/\#4\-\_\-\-Cat\-Mouse\-\_\-\-Obj\-C\-\_\-\-Coupled/src/{\bf C\-M\-G\-U\-I.\-h}\end{DoxyCompactItemize}
