...
/*
float (*var_sg_Geometry_AnimalProduct)(const vector *v1, const vector *v2);
float sg_Geometry_AnimalProduct(const vector *v1, const vector *v2)
{
	return var_sg_Geometry_AnimalProduct(v1,v2);
}
*/
...
struct DLLLoader
{
	DLLLoader()
	{
		...
		//var_sg_Geometry_AnimalProduct = (float (__cdecl *)(const vector *v1, const vector *v2)) GetProcAddress( LibraryHandle, "sg_Geometry_AnimalProduct" );
